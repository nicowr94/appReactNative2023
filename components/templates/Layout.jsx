...
export default function Layout ({children, navigation, btn_back = true}) {
    const { net, setNet, dataOffline, setDataOffline, user } = useContext(UserContext);
    // const [netInfo, setNetInfo] = useState('');
    console.log('------------------------------------');
    console.log('dataOffline', dataOffline);
    console.log('dataOffline.projectClosed', dataOffline.projectClosed);
    console.log('dataOffline.asistenciasOffline', dataOffline.asistenciasOffline);
    ...
    const autoAsistenciaAndProjectClosed = async () => { // sincronizarAsistenciaYCerrarProjectoAutomaticamente
        ...
        console.log('porjectsOffline', porjectsOffline);
        ...
        console.log('asistenciasOfflineList', asistenciasOfflineList);
